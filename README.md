...
[Challenge.lean](Challenge.lean) states Theorem 1.1 and both parts of Proposition 2.1
using only Mathlib imports. [Solution.lean](Solution.lean) imports their canonical
proofs, and [comparator.json](comparator.json) selects precisely these results:
...
`WeakHellinger.three_point_inequality`
...
`WeakHellinger.three_point_inequality_equality`
...
statement retains the paper's upper-limit extension of the divergence quotient.
